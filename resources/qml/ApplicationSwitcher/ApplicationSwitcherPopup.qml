    ...
    contentItem: Grid
    {
        ...
        Repeater
        {
            ...
            [
                ...
                {
                    displayName: "Browse documentation",
                    thumbnail: UM.Theme.getIcon("Library", "high"),
                    description: "Documentation of the FELIX FILO v1 in English and Dutch",
                    link: "https://felixroboticsbv.github.io/FELIX-FILO-docs/",
                    permissionsRequired: []
                }
            ]
